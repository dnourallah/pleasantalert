declare module 'pleasantalert' {
    /**
     * Shorthand function to display a simple PleasantAlert modal.
     *
     * ex.
     *   import pleasant from 'pleasantalert';
     *   pleasant('The Internet?', 'That thing is still around?', 'question');
     */
    function pleasant(title: string, message?: string, type?: PleasantAlertType): Promise<PleasantAlertResult>;

    /**
     * Function to display a pleasantAlert modal, with an object of options, all being optional.
     * See the PleasantAlertOptions interface for the list of accepted fields and values.
     *
     * ex.
     *   import pleasant from 'pleasantalert';
     *   pleasant({
     ...
     *   })
     */
    function pleasant(settings: PleasantAlertOptions & { useRejections?: false }): Promise<PleasantAlertResult>;

    /**
     * @deprecated
     * pleasant() overload for legacy alerts that use { useRejections: true }.
     */
    function pleasant(settings: PleasantAlertOptions & { useRejections: true }): Promise<any>;
     ...
     *   import pleasant from 'pleasantalert';
     *
     *   pleasant('Hey user!', 'I don\'t like you.', 'warning');
     *
     *   if(pleasant.isVisible()) { // instant regret
     *     pleasant.close();
     *   }
     */
    namespace pleasant {
        ...
        /**
         * If you end up using a lot of the same settings when calling pleasantAlert,
         ...
         */
        function setDefaults(defaultOptions: PleasantAlertOptions): void;
        ...
        /**
         * Closes the currently open pleasantAlert modal programmatically.
         *
        ...
        /**
         * Provide an array of pleasantAlert parameters to show multiple modals, one modal after another.
         *
         * @param steps The steps' configuration.
         */
        function queue(steps: Array<PleasantAlertOptions | string>): Promise<any>;
         ...
         *
         * @param step  The step configuration (same object as in the pleasant() call).
         * @param index The index to insert the step at.
         *              By default a modal will be added to the end of a queue.
         */
        function insertQueueStep(step: PleasantAlertOptions, index?: number): number;
        ...
        /**
         * Normalizes the arguments you can give to pleasant() in an object of type PleasantAlertOptions.
         * ex:
         *     pleasant.argsToParams(['title', 'text']); //=> { title: 'title', text: 'text' }
         *     pleasant.argsToParams({ title: 'title', text: 'text' }); //=> { title: 'title', text: 'text' }
         *
         * @param params The array of arguments to normalize.
         */
        function argsToParams(params: PleasantAlertArrayOptions | [PleasantAlertOptions]): PleasantAlertOptions;

        /**
         * An utility function to make pleasantAlert rejections silencious (no error in the console when clicking Cancel).
         * ex. pleasant(...).catch(pleasant.noop)
         */
        function noop(): void;
    ...
    export type PleasantAlertType = 'success' | 'error' | 'warning' | 'info' | 'question';

    export interface PleasantAlertResult {
        value?: any;
        dismiss?: pleasant.DismissReason;
    }
    ...
    export type PleasantAlertArrayOptions = [string] | [string, string] | [string, string, string];

    export interface PleasantAlertOptions {
        /**
         ...
         * pleasantAlert comes with 5 built-in types which will show a corresponding icon animation: 'warning', 'error',
         ...
         * @default null
         */
        type?: PleasantAlertType;

        /**
         * Whether or not pleasantAlert should show a full screen click-to-dismiss backdrop.
        ...
        /**
         * Whether to apply the default pleasant2 styling to buttons.
         ...
         *    html:
         *      '<input id="pleasant-input1" class="padn-input">' +
         *      '<input id="pleasant-input2" class="padn-input">',
         *    focusConfirm: false,
         *    preConfirm: () => [$('#pleasant-input1').val(), $('#pleasant-input2').val()]
         *  }).then(result => pleasant(JSON.stringify(result));
         *
         * @default null
         */
...
/**
 * These interfaces aren't provided by pleasantAlert, but its definitions use them.
